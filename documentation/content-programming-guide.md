...
*(For more information about components, see the [Component programming guide](component-programming-guide.md))*
...
The Hub Framework can be used with any JSON schema, but does provide a default one for convenience. For more information; see the [JSON programming guide](json-programming-guide.md).
