 ...
 *  such as going to a key in a dictionary, or iterating over an array. For more information about how to construct
 *  paths, see the documentation for `HUBJSONPath` and `HUBMutableJSONPath`.
 *
